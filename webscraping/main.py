...
def rank_mundial():
    ...
    #opcao 2022
    if opcao == 1: funcaorankingall(data_2022) 
    if opcao == 2: funcaorankingall(data_2021)
    if opcao == 3: funcaorankingall(data_2020)
    if opcao == 4: funcaorankingall(data_2019)
    if opcao == 5: funcaorankingall(data_2018)
    if opcao == 6: funcaorankingall(data_2017)
    if opcao == 7: funcaorankingall(data_2016)
    if opcao == 8: funcaorankingall(data_2015)
...
def inicio():
    ...
    if botao == 1: kdspositivos()
    if botao == 2: ratingall()
    if botao == 3: roundsall()
    if botao == 4: mapsall()
    if botao == 5: tabelacompleta()
    if botao == 6: rank_mundial()
